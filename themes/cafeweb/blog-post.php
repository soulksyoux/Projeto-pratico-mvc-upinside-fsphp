    ...
    <article class="post_page">
        <header class="post_page_header">
            <div class="post_page_hero">
                <h1><?= $post->title; ?></h1>
                <img class="post_page_cover" alt="<?= $post->title; ?>" title="<?= $post->title; ?>" src="<?= image($post->cover, 1280) ?>"/>
                <div class="post_page_meta">
                    <div class="author">
                        <div><img src="<?= image($post->author()->photo, 40); ?>"/></div>
                        <div class="name">Por: <?php echo $post->author()->first_name . " " . $post->author()->last_name; ?></div>
                    </div>
        ...
        <div class="post_page_content">
            ...
            <aside class="social_share">
                ...
                <div class="social_share_medias">
                    ...
                    <!--twitter-->
                    <a href="https://twitter.com/share?ref_src=site" class="twitter-share-button"
                       data-size="large"
